...
func StatementsMapping() *tableMapping {
	cols := []column{
		...
		col("plan_json", kindString, true, keys("queryInfo", "query_info"), keys("planJson", "plan_json")),
		col("analyze_json", kindString, true, keys("queryInfo", "query_info"), keys("analyzeJson", "analyze_json")),
